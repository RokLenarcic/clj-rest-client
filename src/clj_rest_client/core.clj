...
(defmacro defrest
  ...
  `:post-process-fn` This option specifies function that is invoked with clj-http maps generated by api functions. Defaults to identity.
  ...
  `:edn-key` when loading EDN use a specific key, useful when using refs
  "
